...
<%@ taglib tagdir="/WEB-INF/tags/"  prefix="custom"%>
 <footer>
	<p class="copyright">version: ${applicationScope.metadataProperties.version} - built: ${applicationScope.metadataProperties.buildDate} &#169; Copyright 2013, <a href="/">Acme LLC.</a></p>
</footer>
